...
The Udacity course project python notebooks were exported to HTML and then converted to PDF after running.
...
using RNNs (4) Seq2seq model for language translation and (4) GANs for synthetic face generation.
